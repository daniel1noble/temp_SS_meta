...
```{r echo = TRUE, eval = TRUE}
    pacman::p_load(metafor, MCMCglmm, tidyverse, rotl, magrittr, kableExtra, rmarkdown, gridExtra, psych, metaAidR, bindrcpp, pander)
```
...
```{r echo = TRUE, eval = TRUE, cache = TRUE, message = FALSE, warning = FALSE}
  ...
  tab <- metaAidR::I2(MLMA_male_lnRR, MLMA_male_lnRR$vi)
  # kable(tab)%>%
...
```{r echo = TRUE, eval = TRUE, cache = TRUE, message = FALSE, warning = FALSE}
  tabF <- metaAidR::I2(MLMA_male_lnVR, MLMA_male_lnVR$vi)  
  pander(tabF)
  #kable(tabF)%>%
  #kable_styling(font = 14)
```
...
```{r echo = TRUE, eval = TRUE, cache = TRUE, message = FALSE, warning = FALSE}
  tab2 <- metaAidR::I2(MLMA_male_lnCVR, MLMA_male_lnCVR$vi)  
  pander(tab2)
 #kable(tab2)%>%
  #kable_styling(font = 14)
```
...
##### lnVR - Magnitude
```{r echo = TRUE, eval = TRUE, cache = TRUE, message = FALSE, warning = FALSE}
magnitude_males_mean_VR
```
##### lnCVR - Magnitude
```{r echo = TRUE, eval = TRUE, cache = TRUE, message = FALSE, warning = FALSE}
magnitude_males_mean
```
...
```{r echo = TRUE, eval = TRUE, cache = TRUE, message = FALSE, warning = FALSE}
  tab3 <- metaAidR::I2(MLMA_female_lnRR, MLMA_female_lnRR$vi)
  pander(tab3)
  #kable(tab3)%>%
  #kable_styling(font = 14)
```
...
```{r echo = TRUE, eval = TRUE, cache = TRUE, message = FALSE, warning = FALSE}
  tab4 <- metaAidR::I2(MLMA_female_lnVR, MLMA_female_lnVR$vi)  
  pander(tab4)
  #kable(tab4)%>%
  #kable_styling(font = 14)
```
...
```{r echo = TRUE, eval = TRUE, cache = TRUE, message = FALSE, warning = FALSE}
  table5 <- metaAidR::I2(MLMA_female_lnCVR, MLMA_female_lnCVR$vi)
  pander(table5)  
...
magnitude_mean_females_VR <- mu.fnorm(sol_f_VR[,1], sqrt(rowSums(VCV_f_VR)))
...
##### lnVR - Magnitude
```{r echo = TRUE, eval = TRUE, cache = TRUE, message = FALSE, warning = FALSE}
magnitude_females_mean_VR
```
##### lnCVR - Magnitude
```{r echo = TRUE, eval = TRUE, cache = TRUE, message = FALSE, warning = FALSE}
magnitude_females_mean
```
...
### Effect sizes derived from proportions
...
### Adapted temperatures of the population – A discussion
...
### Trait dependency among effects
